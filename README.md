...
|----------|:-------------:|:------|
|[125. Valid Palindrome](https://leetcode.com/problems/valid-palindrome/)|[Code](/125_Valid_Palindrome.py)| Check if original & reverse string are the same (ie: return <p>result == result[::-1]</p>)|
